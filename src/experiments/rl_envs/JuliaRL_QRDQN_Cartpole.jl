function RLCore.Experiment(
    ...
    if isnothing(save_dir)
        ...
        save_dir = joinpath(pwd(), "checkpoints", "JuliaRL_QRDQN_CartPole_$(t)")
    end
    ...
    description = """
    This experiment uses the `QRDQNLearner` method with three dense layers to approximate the Q value.
