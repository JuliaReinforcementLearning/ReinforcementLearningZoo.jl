@testset "BestResponsePolicy" begin
    ...
    @testset "Uniform Best Response" begin
        ...
        expected_response_0 = Dict{String, Int}("0"=>1, "0pb"=>0, "1"=>1, "1pb"=>1, "2"=>0, "2pb"=>1)
        expected_response_1 = Dict{String, Int}("0b"=>0, "0p"=>1, "1b"=>1, "1p"=>1, "2b"=>1, "2p"=>1)
    ...
    @testset "corner case test" begin
        ...
        kuhn_exploitability_descent_iter4_policy = TabularRandomPolicy(table=Dict(
        ...
        expected_response_1 = Dict("0b"=>0, "0p"=>0, "1b"=> 1, "1p"=> 1, "2b"=> 1, "2p"=> 1)
    ...
    @testset "best response for optimal policy" begin
        ...
        expected_response_0 = Dict("0"=>0, "0pb"=>0, "1"=>0, "1pb"=>0, "2"=>0, "2pb"=>1)
        expected_response_1 = Dict("0b"=>0, "0p"=>0, "1p"=>0, "1b"=>0, "2p"=>1, "2b"=>1)
